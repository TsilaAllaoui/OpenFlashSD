...
#include "bn_sprite_items_openflash_variable_8x8_font.h"
...
namespace common
{
    ...
    constexpr bn::sprite_font variable_8x8_sprite_font(bn::sprite_items::openflash_variable_8x8_font,
                                         bn::utf8_characters_map_ref(),
                                         variable_8x8_sprite_font_character_widths);
}

#endif // COMMON_VARIABLE_8X8_SPRITE_FONT_H
