...
namespace openflash
{
    namespace mock
    {
        const bn::vector<file_entry, max_file_count> &mock_file_entries()
        {
            ...
            files.push_back(file_entry("Pokemon Emerald.gba",
                                       ...
                                       2,
                                       16777216));
            files.push_back(file_entry("Pokemon FireRed.gba",
            ...
            files.push_back(file_entry("Pokemon Unbound.gba",
                                       ...
                                       3,
                                       33554432));
            files.push_back(file_entry("Pokemon Radical Red.gba",
            ...
            files.push_back(file_entry("Patcher.gba",
                                       ...
                                       4,
                                       524288));
            files.push_back(file_entry("Editor.gba",
            ...
            files.push_back(file_entry("Super Mario Advance.gba",
                                       ...
                                       2,
                                       4194304));
            files.push_back(file_entry("Mario Kart Super Circuit.gba",
                                       ...
                                       2,
                                       4194304));
            files.push_back(file_entry("Mario Party Advance.gba",
            ...
            files.push_back(file_entry("Mario USA.gba",
            ...
            files.push_back(file_entry("Mario Europe.gba",
            ...
            files.push_back(file_entry("Mario Japan.gba",
            ...
            files.push_back(file_entry("The Minish Cap.gba",
                                       ...
                                       2,
                                       16777216));
            files.push_back(file_entry("A Link to the Past.gba",
            ...
            files.push_back(file_entry("Minish Cap Randomizer.gba",
            ...
            files.push_back(file_entry("Wario Land 4.gba",
                                       ...
                                       2,
                                       8388608));
            files.push_back(file_entry("WarioWare Twisted.gba",
            ...
            files.push_back(file_entry("Pokemon Emerald.sav",
                                       "/SAVES/Pokemon/Pokemon Emerald.sav",
                                       file_type::SAVE_FILE,
                                       32,
                                       31,
                                       2,
                                       131072));
            files.push_back(file_entry("Pokemon FireRed.sav",
                                       "/SAVES/Pokemon/Pokemon FireRed.sav",
                                       file_type::SAVE_FILE,
                                       33,
                                       31,
                                       2,
            ...
            files.push_back(file_entry("backup.sav",
                                       "/SAVES/Backups/2026/January/backup.sav",
                                       file_type::SAVE_FILE,
                                       37,
                                       36,
                                       4,
            ...
            files.push_back(file_entry("Metroid Fusion.gba",
                                       ...
                                       2,
                                       8388608));
            files.push_back(file_entry("Metroid Zero Mission.gba",
                                       ...
                                       2,
                                       8388608));
            files.push_back(file_entry("Castlevania - Aria of Sorrow.gba",
            ...
            files.push_back(file_entry("Pokemon Crystal.gbc",
                                       "/ROMS/GBC/Pokemon Crystal.gbc",
                                       file_type::NORMAL_FILE,
                                       44,
                                       43,
                                       2,
                                       2097152));
            files.push_back(file_entry("Zelda Oracle of Ages.gbc",
                                       "/ROMS/GBC/Zelda Oracle of Ages.gbc",
                                       file_type::NORMAL_FILE,
                                       45,
                                       43,
                                       2,
            ...
            files.push_back(
                file_entry("FlashTool.gba", "/APPS/Flash/FlashTool.gba", file_type::GBA_FILE, 48, 47, 2, 524288));
            files.push_back(file_entry("Flash1M Patcher.gba",
            ...
            files.push_back(file_entry("Save Manager.gba",
            ...
            files.push_back(
                file_entry("theme.cfg", "/CONFIG/Themes/Default/theme.cfg", file_type::NORMAL_FILE, 55, 54, 3, 2048));

            files.push_back(
                file_entry("settings.ini", "/CONFIG/settings.ini", file_type::NORMAL_FILE, 56, 52, 1, 1024));
            ...
            files.push_back(file_entry("ROM Checker.gba",
                                       ...
                                       3,
                                       262144));
            files.push_back(file_entry("Header Editor.gba",
            ...
            files.push_back(
                file_entry("debug.log", "/TOOLS/Development/Debug/debug.log", file_type::NORMAL_FILE, 63, 62, 3, 8192));
        ...
        bn::array<uint8_t, gba_header_size> get_gba_header(bn::string_view filename_or_path)
        {
            ...
            {
                if (filename_or_path == rom.filename || filename_or_path == rom.path)
                {
                    found = &rom;
                    break;
                }
        ...
        rom_infos get_gba_file_info(uint8_t *rom_bytes)
        {
            ...
            // Save type
            auto result = bn::find_if(mock_roms_infos.begin(),
                                      mock_roms_infos.end(),
                                      [&](const mock_rom_info &rom_infos) { return rom_infos.title == infos.name; });
